...
// import photo from "../../../src/assets/photo"
...
return(
 ...
 <img className="aboutme-photo"  src= "/assets/profilephoto.jpg" alt=""/>
 <br />
 <br />
 <br />
 <div class="aboutme">
  Hello, Im Brian.
  Im a Full Stack Web Development Bootcamp student. Currentlying learning MERN stack and close to graduating form the program. I enjoy learning new aspects of
